...
class VideoFields:
    ...
    download_video = Boolean(
        help=_("Allow students to download versions of this video in different formats if they cannot use the Robeli video"
    ...
    edx_video_id = String(
        help=_("If you were assigned a Video ID by Robeli for the video to play in this component, enter the ID here."
